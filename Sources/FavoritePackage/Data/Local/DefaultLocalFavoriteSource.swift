...
import CoreOfflineAppTestKit
 ...
 public class DefaultLocalFavoriteSource: NSObject {
...
extension DefaultLocalFavoriteSource: LocalFavoriteSource {
    public func getFavorites() -> Observable<[GameEntity]> {
    ...
    public func getFavoritebyId(from id: String) -> Observable<[GameEntity]> {
        return Observable<[GameEntity]>.create { observer in
          if let realm = self.realm {
    ...
    public func addFavorite(from game: GameEntity) -> Observable<Bool> {
    ...
    public func deleteFavorite(from game: GameEntity) -> Observable<Bool> {
        return Observable<Bool>.create { observer in
            if let realm = self.realm {
                let game: Results<GameEntity> = {
